...
export default function Home() {
  ...
  const handleCreateConversation = async () => {
    ...
    try {
      ...
      //this down below is from ChatGPT recommendation 

      // 🔥 ADD THIS LINE
    const aiResponse = await getAIResponse(newConversation.context.trim());
console.log("AI reply:", aiResponse);


      //theabove is from chatGPT recommendation 
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Chat Memory</Text>
            <Text style={styles.cardSubtitle}>Everything stored securely</Text>
          ...
          {conversations.length > 0 ? (
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyStateSubtitle}>
                Start conversations with Habesha AI
              </Text>
              <TouchableOpacity
              ...
              >
                <Ionicons name="add-circle-outline" size={20} color="#FFFFFF" />
                <Text style={styles.emptyStateButtonText}>Start First Conversation</Text>
              </TouchableOpacity>
            </View>
          )}
        </View>
